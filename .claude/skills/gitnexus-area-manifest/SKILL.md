...
description: "Skill for the Manifest area of Event-Horizon. 510 symbols across 117 files."
---

# Manifest

510 symbols | 117 files | Cohesion: 73%
...
| `src/core/manifest/readZip.ts` | ZipReadError, extractZipEntryToFile, findDataOffset, findEntry, findZip64Extra (+21) |
...
| `src/core/manifest/packageZip.ts` | PackageEhcollError, describeBytes, listBundles, packageEhcoll, prepareStagingDir (+15) |
...
| `src/core/manifest/bundleZip.ts` | writeChunk, listBundleFolder, bundleFilesFromListing, bundleFilesFromPackage, writeBundleZipToFile (+7) |
...
| `PackageEhcollError` | Class | `src/core/manifest/packageZip.ts` | 197 |
| `BuildRefusedError` | Class | `src/ui/pages/build/engine.ts` | 1122 |
| `BundleResolutionError` | Class | `src/ui/pages/build/engine.ts` | 589 |
| `ZipReadError` | Class | `src/core/manifest/readZip.ts` | 80 |
