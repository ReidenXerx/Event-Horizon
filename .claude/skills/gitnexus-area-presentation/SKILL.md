...
description: "Skill for the Presentation area of Event-Horizon. 47 symbols across 8 files."
---

# Presentation

47 symbols | 8 files | Cohesion: 73%
...
| `src/core/presentation/presentationAssets.ts` | PresentationImageError, importPresentationImage, measure, megabytes, readHead (+3) |
