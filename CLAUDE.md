...
This project is indexed by GitNexus as **Event-Horizon** (15843 symbols, 44589 relationships, 603 execution flows).
...
| Work in the Manifest area (522 symbols) | `.claude/skills/gitnexus-area-manifest/SKILL.md` |
| Work in the Build area (509 symbols) | `.claude/skills/gitnexus-area-build/SKILL.md` |
| Work in the Installer area (493 symbols) | `.claude/skills/gitnexus-area-installer/SKILL.md` |
| Work in the Curator area (384 symbols) | `.claude/skills/gitnexus-area-curator/SKILL.md` |
| Work in the Environment area (127 symbols) | `.claude/skills/gitnexus-area-environment/SKILL.md` |
| Work in the Install area (105 symbols) | `.claude/skills/gitnexus-area-install/SKILL.md` |
| Work in the Resolver area (78 symbols) | `.claude/skills/gitnexus-area-resolver/SKILL.md` |
| Work in the Doctor area (77 symbols) | `.claude/skills/gitnexus-area-doctor/SKILL.md` |
| Work in the Scripts area (72 symbols) | `.claude/skills/gitnexus-area-scripts/SKILL.md` |
| Work in the Ui area (69 symbols) | `.claude/skills/gitnexus-area-ui/SKILL.md` |
| Work in the Table area (57 symbols) | `.claude/skills/gitnexus-area-table/SKILL.md` |
| Work in the Runtime area (53 symbols) | `.claude/skills/gitnexus-area-runtime/SKILL.md` |
| Work in the Presentation area (49 symbols) | `.claude/skills/gitnexus-area-presentation/SKILL.md` |
...
| Work in the Pages area (27 symbols) | `.claude/skills/gitnexus-area-pages/SKILL.md` |
| Work in the Errors area (19 symbols) | `.claude/skills/gitnexus-area-errors/SKILL.md` |
| Work in the Nexus area (16 symbols) | `.claude/skills/gitnexus-area-nexus/SKILL.md` |
