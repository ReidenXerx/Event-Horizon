...
description: "Skill for the Proton area of Event-Horizon. 33 symbols across 7 files."
---
...
- Understanding how isDirectory, probeWinePrefix, distinct work
...
| `scanHomes` | Function | `src/core/proton/gamePrefix.ts` | 63 |
...
1. `context({name: "isDirectory"})` — see callers and callees
