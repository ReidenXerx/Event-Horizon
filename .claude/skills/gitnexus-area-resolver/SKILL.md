...
description: "Skill for the Resolver area of Event-Horizon. 56 symbols across 12 files."
---

# Resolver

56 symbols | 12 files | Cohesion: 79%
...
| `decide` | Function | `src/core/resolver/resumeIdentity.test.ts` | 73 |
