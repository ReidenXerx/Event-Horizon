...
This project is indexed by GitNexus as **Event-Horizon** (11511 symbols, 31163 relationships, 523 execution flows).
...
| Work in the Manifest area (551 symbols) | `.claude/skills/gitnexus-area-manifest/SKILL.md` |
| Work in the Build area (435 symbols) | `.claude/skills/gitnexus-area-build/SKILL.md` |
| Work in the Installer area (319 symbols) | `.claude/skills/gitnexus-area-installer/SKILL.md` |
| Work in the Curator area (139 symbols) | `.claude/skills/gitnexus-area-curator/SKILL.md` |
| Work in the Environment area (110 symbols) | `.claude/skills/gitnexus-area-environment/SKILL.md` |
| Work in the Install area (79 symbols) | `.claude/skills/gitnexus-area-install/SKILL.md` |
| Work in the Scripts area (56 symbols) | `.claude/skills/gitnexus-area-scripts/SKILL.md` |
| Work in the Resolver area (53 symbols) | `.claude/skills/gitnexus-area-resolver/SKILL.md` |
...
| Work in the Doctor area (26 symbols) | `.claude/skills/gitnexus-area-doctor/SKILL.md` |
| Work in the Table area (23 symbols) | `.claude/skills/gitnexus-area-table/SKILL.md` |
| Work in the Runtime area (21 symbols) | `.claude/skills/gitnexus-area-runtime/SKILL.md` |
| Work in the Components area (21 symbols) | `.claude/skills/gitnexus-area-components/SKILL.md` |
...
| Work in the Cluster_190 area (12 symbols) | `.claude/skills/gitnexus-area-cluster-190/SKILL.md` |
| Work in the Bearing-teaching area (9 symbols) | `.claude/skills/gitnexus-area-bearing-teaching/SKILL.md` |
| Work in the Diagnostics area (9 symbols) | `.claude/skills/gitnexus-area-diagnostics/SKILL.md` |
