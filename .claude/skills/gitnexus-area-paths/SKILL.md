...
description: "Skill for the Paths area of Event-Horizon. 22 symbols across 10 files."
---

# Paths

22 symbols | 10 files | Cohesion: 56%
...
| File | Symbols |
|------|---------|
| `src/core/paths/modPath.ts` | basenameOf, extensionOf, rebaseUnder, relativeUnder, fold |
...
| `src/core/proton/gamePrefix.ts` | pick |
...
| `pick` | Function | `src/core/proton/gamePrefix.ts` | 193 |
