...
description: "Skill for the Presentation area of Event-Horizon. 46 symbols across 8 files."
---

# Presentation

46 symbols | 8 files | Cohesion: 74%
...
| File | Symbols |
|------|---------|
| `src/core/presentation/presentation.ts` | presentationImages, withImagesPresent, keep, isEmptyPresentation, isPresentationEntry (+17) |
...
| `loadCachedPresentation` | Function | `src/core/presentation/presentationCache.ts` | 154 |
