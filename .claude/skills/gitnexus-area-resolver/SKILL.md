...
description: "Skill for the Resolver area of Event-Horizon. 81 symbols across 20 files."
---

# Resolver

81 symbols | 20 files | Cohesion: 71%
...
| `src/core/resolver/enrichStagingSetHashes.ts` | bundledInstallName, collectExternalStagingSetHashTargets, collectStagingSetHashTargetsForTest, enrichInstalledModsWithStagingSetHashes, normalizeName |
...
| `bundledArchiveFileName` | Function | `src/core/installer/modInstall.ts` | 1464 |
...
| `EnrichInstalledModsWithStagingSetHashes → BundledArchiveFileName` | intra_community | 4 |
