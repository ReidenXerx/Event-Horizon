...
description: "Skill for the Installer area of Event-Horizon. 493 symbols across 117 files."
---

# Installer

493 symbols | 117 files | Cohesion: 72%

## When to Use

- Working with code in `src/`
- Understanding how describeGameIniApplication, shouldApplyGameIni, applyIniTweakRemovals work
...
| `src/core/installLedger.ts` | InstallLedgerError, expectString, getInstallLedgerDir, getReceiptPath, isIso8601 (+14) |
...
| `src/core/installer/applyMirrors.ts` | batchesOf, extractWithSevenZip, forEvery, listZipIfNamesCertain, messageOf (+7) |
